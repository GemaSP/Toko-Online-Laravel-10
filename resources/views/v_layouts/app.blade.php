                ...
                <div class="pull-right">
                    ...
                    <ul class="header-btns">
                        ...
                        <li class="header-cart dropdown default-dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                <div class="header-btns-icon">
                                    ...
                                    <span class="qty">{{ $totalHarga ?? 0 }}</span>
                                </div>
                            ...
                            <div class="custom-menu">
                                <div id="shopping-cart">
                                    <div class="shopping-cart-list">
                                        ...
                                        <div class="product product-widget">
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-price">Rp. {{ number_format($item->harga, 0, ',', '.') }}<span class="qty"> x{{ $item->quantity }}</span></h3>
                                                <h2 class="product-name"><a href="#">{{ $item->produk->nama_produk }}</a></h2>
                                            </div>
                                    ...
                                    <div class="shopping-cart-btns">
                                        <a href="{{ route('order.cart') }}" class="main-btn">View Cart</a>
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                            ...
                            <br>
                            <span><a href="{{ route('auth.redirect') }}">Login</a></span>
                        </a>
                        <ul class="custom-menu">
                            <li><a href="{{ route('auth.redirect') }}"><i class="fa fa-unlock-alt"></i> Login</a></li>
