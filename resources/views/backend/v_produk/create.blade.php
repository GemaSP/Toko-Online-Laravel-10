                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="foto" onchange="previewFoto()" class="form-control @error('foto') is-invalid @enderror">
                                    @error('foto')
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="detail" id="ckeditor" class="form-control @error('detail') is-invalid @enderror">{{ old('detail') }}</textarea>
                                    @error('detail')
                                    <span class="invalid-feedback alert-danger"
                                        role="alert">
                                        {{ $message }}
